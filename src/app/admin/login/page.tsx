    ...
    <div className="grid min-h-screen place-items-center bg-gradient-to-br from-green-700 to-green-800 px-6">
      <div className="w-full max-w-sm rounded-3xl bg-white p-8 shadow-2xl">
        <div className="text-center">
          ...
          <img src="/logo.png" alt="SÖZTEK Bilgisayar" className="mx-auto h-16 w-auto" />
        ...
        <form action={action} className="mt-6 space-y-4">
          <div>
            ...
            <input name="email" type="email" required defaultValue="admin@soztek.com.tr" className="w-full rounded-xl border border-green-200 px-4 py-3 text-sm outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100" />
          </div>
          <div>
