...
import { LayoutDashboard, Package, FolderTree, ShoppingCart, Users, Settings, LogOut, ExternalLink, FileDown, ImagePlus } from "lucide-react";
...
const NAV = [
  ...
  { href: "/admin/dosyalar", label: "Dosyalar", icon: FileDown },
  { href: "/admin/gorsel", label: "Görsel Linki", icon: ImagePlus },
      ...
      <div className="mx-auto flex max-w-[1400px]">
        ...
        <aside className="sticky top-0 hidden h-screen w-60 shrink-0 flex-col border-r border-green-100 bg-white p-4 lg:flex">
          <Link href="/admin" className="mb-6 flex items-center px-2">
            ...
            <img src="/logo.png" alt="SÖZTEK Bilgisayar" className="h-10 w-auto" />
          </Link>
