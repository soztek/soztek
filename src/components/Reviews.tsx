...
const REVIEWS: Review[] = [
  {
    name: "Ahmet K.",
    city: "İstanbul",
    text: "Topladığım oyun bilgisayarının tüm parçalarını buradan aldım. Fiyatlar piyasadan uygun, kargo aynı gün çıktı. Teknik ekip parça uyumunda da yardımcı oldu.",
  },
  {
    name: "Merve D.",
    city: "Ankara",
    text: "Ofisimiz için 15 adet monitör ve klavye-mouse seti sipariş verdik. Kurumsal faturalı, sorunsuz ve zamanında teslim. Kesinlikle tavsiye ederim.",
  },
  {
    name: "Serkan A.",
    city: "İzmir",
    text: "Ekran kartını taksitle aldım, vade farkı yok. Ürün orijinal ve garantili geldi. Satış sonrası destek için aradığımda hemen dönüş yaptılar.",
  },
  {
    name: "Buse T.",
    city: "Bursa",
    text: "Güvenlik kamerası setini montaj önerileriyle birlikte aldım. Paketleme çok özenliydi, hiçbir eksik yoktu. Fiyat/performans harika.",
  },
  {
    name: "Emre S.",
    city: "Antalya",
    text: "SSD ve RAM yükseltmesi için sipariş verdim, ertesi gün elimdeydi. Site güvenli, ödeme sorunsuz. Artık tüm donanım ihtiyacımı buradan karşılıyorum.",
  },
  {
    name: "Okan Y.",
    city: "Kocaeli",
    text: "Yazıcı ve toner alışverişimi buradan yapıyorum. Stoklar güncel, sipariş ettiğim ürün her zaman anında hazırlanıyor. Güvenilir bir firma.",
  },
];
